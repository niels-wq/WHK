...
const URL_META = {
  ...
  '/beschikking-uitleg':           { title: 'Wat is de Werkhervattingskas (WHK)? Beschikking lezen en bezwaar', desc: 'WHK-beschikking lezen: dagtekening, loonsom, toerekening en premie. Inclusief wanneer bezwaar bij Belastingdienst of UWV relevant is. Geen juridisch advies.' },
  ...
  '/tools/wia-calculator':         { title: 'WIA berekenen: WGA, IVA en wanneer bezwaar bij UWV [2026]', desc: 'WIA, WGA of IVA berekenen op dagloon en AO-percentage. Inclusief WHK-impact en wanneer bezwaar of herbeoordeling bij het UWV de moeite waard is. Indicatief, gratis.' },
